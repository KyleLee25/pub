...
public class GetStudentRegistrationsHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        try {
            ...
            context.getLogger().log("Getting registrations for student: " + studentId);
            ...
            String tableName = System.getenv("REGISTRATIONS_TABLE");
            ...
            context.getLogger().log("Found " + response.items().size() + " registrations");
